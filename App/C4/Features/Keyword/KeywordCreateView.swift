            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                HStack(alignment: .top, spacing: 20) {
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        TextField("ex.애플 디벨로퍼 아카데미 C4", text: $viewModel.draftExperienceTitle)
                ...
                // MARK: - 경험 진술
                VStack(alignment: .leading, spacing: 10) {
                    SectionHeader(title: "경험 작성", descriptions: "아래 질문에 답하듯 편하게 썰을 풀어주세요. 완벽한 문장이 아니어도 괜찮아요! 자세한 내용이 담길수록 명확한 에피소드가 생성됩니다.")
                    
                    ZStack(alignment: .topLeading) {
                        // 플레이스홀더 텍스트
                        if viewModel.draftStatement.isEmpty {
                            Text("막막하다면 아래 질문에 대답하듯 의식의 흐름대로 적어보세요!\n\nQ. 이 프로젝트에서 나의 메인 역할은 무엇이었나요?\nQ. 진행 중 겪었던 가장 빡쳤던(?) 위기나 한계는 무엇이었나요?\nQ. 그 위기를 넘기기 위해 '나'는 구체적으로 어떤 고민과 행동을 했나요?\nQ. 결과적으로 무엇을 이뤄냈고, 무엇을 배웠나요?")
